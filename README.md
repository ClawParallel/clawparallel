...
This repository can be fully created using a mobile phone

The bot cannot be executed on mobile

Mobile usage is intended for:
...
[x] Token concept ($CLAWP)

[ ] Discord integration

[ ] Bankrbot deployment

[ ] On-chain PARALLEL adapter
...
ClawParallel is not built for short-term hype.
It is built as long-term infrastructure for PARALLEL.

> “Parallel needs systems, not noise.”
...
ClawParallel is a foundation — not a finished product.
